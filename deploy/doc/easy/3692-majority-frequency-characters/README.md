# [Majority Frequency Characters][title]
...
**any** order. If two or more frequency groups tie for that largest size, pick
the group whose frequency `k` is **larger**.
...
majority frequency group. There is a tie in group size with frequency 1, but
we pick the higher frequency: 2.
...
[title]: https://leetcode.com/problems/majority-frequency-characters
