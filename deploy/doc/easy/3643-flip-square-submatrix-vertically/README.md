# [Flip Square Submatrix Vertically][title]
...
The integers `x` and `y` represent the row and column indices of the **top-
left** corner of a **square** submatrix and the integer `k` represents the
