# [Sort Integers by Binary Reflection][title]
...
obtained by reversing the order of its **binary** digits (ignoring any leading
zeros) and interpreting the resulting binary number as a decimal.
...
Note that 3 and 6 have the same reflection, so we arrange them in increasing
order of original value.
...
[title]: https://leetcode.com/problems/sort-integers-by-binary-reflection
