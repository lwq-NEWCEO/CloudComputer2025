# [Largest 3-Same-Digit Number in String][title]
...
**Example 1:**
            Input: num = "6** _777_** 133339"    Output: "777"    Explanation: There are two distinct good integers: "777" and "333".    "777" is the largest, so we return "777".    

**Example 2:**
            Input: num = "23** _000_** 19"    Output: "000"    Explanation: "000" is the only good integer.    
