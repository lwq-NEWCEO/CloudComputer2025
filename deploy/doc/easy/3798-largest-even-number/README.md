# [Largest Even Number][title]

## Description

You are given a string `s` consisting only of the characters `'1'` and `'2'`.

You may delete any number of characters from `s` without changing the order of
...
Deleting `'1'` results in the largest possible even number which is equal to
22.
...
[title]: https://leetcode.com/problems/largest-even-number
