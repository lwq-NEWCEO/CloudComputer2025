# [Maximize Expression of Three Elements][title]

## Description

You are given an integer array `nums`.

Choose three elements `a`, `b`, and `c` from `nums` at **distinct** indices
...
We can choose `a = 4`, `b = 5`, and `c = 1`. The expression value is `4 + 5 -
1 = 8`, which is the maximum possible.
...
[title]: https://leetcode.com/problems/maximize-expression-of-three-elements
