...
**Example 1:**
            Input: s = "XXX"    Output: 1    Explanation: _XXX_ -> OOO    We select all the 3 characters and convert them in one move.    

**Example 2:**
            Input: s = "XXOX"    Output: 2    Explanation: _XXO_ X -> O _OOX_ -> OOOO    We select the first 3 characters in the first move, and convert them to 'O'.    Then we select the last 3 characters and convert them so that the final string contains all 'O's.
