...
**Example 1:**
            Input: sentence = "_cat_ _and_  _dog_ "    Output: 3    Explanation: The valid words in the sentence are "cat", "and", and "dog".    
...
**Example 3:**
            Input: sentence = "_alice_ _and_  _bob_ _are_ _playing_ stone-game10"    Output: 5    Explanation: The valid words in the sentence are "alice", "and", "bob", "are", and "playing".    "stone-game10" is invalid because it contains digits.    
