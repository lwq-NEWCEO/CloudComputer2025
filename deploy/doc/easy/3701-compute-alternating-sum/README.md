# [Compute Alternating Sum][title]

## Description

You are given an integer array `nums`.

The **alternating sum** of `nums` is the value obtained by **adding** elements
at even indices and **subtracting** elements at odd indices. That is, `nums[0]
...
[title]: https://leetcode.com/problems/compute-alternating-sum
