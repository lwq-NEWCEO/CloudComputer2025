# [Counting Words With a Given Prefix][title]
...
**Example 1:**
            Input: words = ["pay","**_at_** tention","practice","_**at**_ tend"], pref = "at"    Output: 2    Explanation: The 2 strings that contain "at" as a prefix are: "_**at**_ tention" and "_**at**_ tend".    
