...
Note: **Any** activity from (`'open_session'`, `'end_session'`,
`'scroll_down'`, `'send_message'`) will be considered valid activity for a
user to be considered active on a day.
...
[title]: https://leetcode.com/problems/user-activity-for-the-past-30-days-i
