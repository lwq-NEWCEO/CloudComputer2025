...
We need to group the numbers from `1` to `n` according to the sum of its
digits. For example, the numbers 14 and 5 belong to the **same** group,
...
[title]: https://leetcode.com/problems/count-largest-group
