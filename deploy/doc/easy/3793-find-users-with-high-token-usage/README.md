# [Find Users with High Token Usage][title]
...
Return _the result table ordered by**average tokens** in **descending** order,
and then by `user_id` in **ascending** order._
...
[title]: https://leetcode.com/problems/find-users-with-high-token-usage
