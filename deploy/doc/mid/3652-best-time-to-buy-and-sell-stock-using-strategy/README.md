# [Best Time to Buy and Sell Stock using Strategy][title]
...
You are given two integer arrays `prices` and `strategy`, where:
  ...
  * `strategy[i]` represents a trading action on the `ith` day, where:     * `-1` indicates buying one unit of the stock.    * `0` indicates holding the stock.    * `1` indicates selling one unit of the stock.
...
The **profit** is defined as the **sum** of `strategy[i] * prices[i]` across
all days.
