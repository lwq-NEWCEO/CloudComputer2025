...
However, they differ in both indices, so they are not compatible. Thus, the
output is 0.
...
[title]: https://leetcode.com/problems/two-letter-card-game
