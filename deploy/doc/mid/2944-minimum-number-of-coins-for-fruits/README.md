# [Minimum Number of Coins for Fruits][title]

## Description

You are given an **0-indexed** integer array `prices` where `prices[i]`
denotes the number of coins needed to purchase the `(i + 1)th` fruit.
...
purchase it for `prices[j - 1]` coins to receive its reward.
...
[title]: https://leetcode.com/problems/minimum-number-of-coins-for-fruits
