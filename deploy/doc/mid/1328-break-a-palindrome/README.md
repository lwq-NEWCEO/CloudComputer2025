...
**Example 1:**
            Input: palindrome = "abccba"    Output: "aaccba"    Explanation: There are many ways to make "abccba" not a palindrome, such as "_z_ bccba", "a _a_ ccba", and "ab _a_ cba".    Of all the ways, "aaccba" is the lexicographically smallest.    
