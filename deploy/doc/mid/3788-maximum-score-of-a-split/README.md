# [Maximum Score of a Split][title]
...
The optimal split is at `i = 2`, `score(2) = prefixSum(2) - suffixMin(2) = (10
+ (-1) + 3) - (-5) = 17`.
...
[title]: https://leetcode.com/problems/maximum-score-of-a-split
