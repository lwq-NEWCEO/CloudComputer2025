# [Find Consistently Improving Employees][title]
...
Return _the result table ordered by**improvement score** in **descending**
order, then by **name** in **ascending** order_.
...
The output table is ordered by improvement_score in descending order, then by
...
[title]: https://leetcode.com/problems/find-consistently-improving-employees
