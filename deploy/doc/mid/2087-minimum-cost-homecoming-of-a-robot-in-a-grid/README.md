...
![](https://assets.leetcode.com/uploads/2021/10/11/eg-1.png)
            Input: startPos = [1, 0], homePos = [2, 3], rowCosts = [5, 4, 3], colCosts = [8, 2, 6, 7]    Output: 18    Explanation: One optimal path is that:    Starting from (1, 0)    -> It goes down to (_**2**_ , 0). This move costs rowCosts[2] = 3.    -> It goes right to (2, _**1**_). This move costs colCosts[1] = 2.    -> It goes right to (2, _**2**_). This move costs colCosts[2] = 6.    -> It goes right to (2, _**3**_). This move costs colCosts[3] = 7.    The total cost is 3 + 2 + 6 + 7 = 18
