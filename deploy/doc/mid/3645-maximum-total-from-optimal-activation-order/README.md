# [Maximum Total from Optimal Activation Order][title]
...
Return the **maximum** **total** you can obtain by choosing the activation
order optimally.
...
[title]: https://leetcode.com/problems/maximum-total-from-optimal-activation-order
