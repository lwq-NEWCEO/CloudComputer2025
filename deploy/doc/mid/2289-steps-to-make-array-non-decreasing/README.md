# [Steps to Make Array Non-decreasing][title]
...
**Example 1:**
            Input: nums = [5,3,4,4,7,3,6,11,8,5,11]    Output: 3    Explanation: The following are the steps performed:    - Step 1: [5,**_3_** ,4,4,7,_**3**_ ,6,11,_**8**_ ,_**5**_ ,11] becomes [5,4,4,7,6,11,11]    - Step 2: [5,_**4**_ ,4,7,_**6**_ ,11,11] becomes [5,4,7,11,11]    - Step 3: [5,_**4**_ ,7,11,11] becomes [5,7,11,11]    [5,7,11,11] is a non-decreasing array. Therefore, we return 3.    
