# [Find Longest Special Substring That Occurs Thrice II][title]
...
**Example 1:**
            Input: s = "aaaa"    Output: 2    Explanation: The longest special substring which occurs thrice is "aa": substrings "_**aa**_ aa", "a _**aa**_ a", and "aa _**aa**_ ".    It can be shown that the maximum length achievable is 2.    

**Example 2:**
            Input: s = "abcdef"    Output: -1    Explanation: There exists no special substring which occurs at least thrice. Hence return -1.    

**Example 3:**
            Input: s = "abcaba"    Output: 1    Explanation: The longest special substring which occurs thrice is "a": substrings "_**a**_ bcaba", "abc _**a**_ ba", and "abcab _**a**_ ".    It can be shown that the maximum length achievable is 1.    
