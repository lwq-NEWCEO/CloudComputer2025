# [Count Distinct Integers After Removing Zeros][title]
...
The integers we wrote down are 1, 2, 3. There are 3 distinct integers (1, 2,
3).
...
[title]: https://leetcode.com/problems/count-distinct-integers-after-removing-zeros
