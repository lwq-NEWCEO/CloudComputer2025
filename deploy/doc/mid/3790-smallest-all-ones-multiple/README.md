# [Smallest All-Ones Multiple][title]
...
`n = 111` because 111 is divisible by 3, but 1 and 11 are not. The length of
`n = 111` is 3.
...
[title]: https://leetcode.com/problems/smallest-all-ones-multiple
