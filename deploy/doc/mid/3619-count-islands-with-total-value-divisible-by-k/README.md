# [Count Islands With Total Value Divisible by K][title]

## Description

You are given an `m x n` matrix `grid` and a positive integer `k`. An
**island** is a group of **positive** integers (representing land) that are
...
[title]: https://leetcode.com/problems/count-islands-with-total-value-divisible-by-k
