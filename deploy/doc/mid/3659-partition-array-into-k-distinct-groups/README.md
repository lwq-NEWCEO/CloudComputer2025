# [Partition Array Into K-Distinct Groups][title]
...
`nums` into one or more groups such that:
...
[title]: https://leetcode.com/problems/partition-array-into-k-distinct-groups
