# [Number of Subarrays With GCD Equal to K][title]
...
**Example 1:**
            Input: nums = [9,3,1,2,6,3], k = 3    Output: 4    Explanation: The subarrays of nums where 3 is the greatest common divisor of all the subarray's elements are:    - [9,_**3**_ ,1,2,6,3]    - [9,3,1,2,6,_**3**_]    - [_**9,3**_ ,1,2,6,3]    - [9,3,1,2,_**6,3**_]    
...
[title]: https://leetcode.com/problems/number-of-subarrays-with-gcd-equal-to-k
