# [Lexicographically Smallest Negated Permutation that Sums to Target][title]
...
The arrays that sum to 0 and whose absolute values form a permutation of size
3 are:
...
There are no arrays that sum to 10000000000 and whose absolute values form a
permutation of size 1. Therefore, the answer is `[]`.
...
[title]: https://leetcode.com/problems/lexicographically-smallest-negated-permutation-that-sums-to-target
