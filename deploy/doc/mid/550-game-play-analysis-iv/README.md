...
In other words, you need to determine the number of players who logged in on
the day immediately following their initial login, and divide it by the number
of total players.
...
[title]: https://leetcode.com/problems/game-play-analysis-iv
