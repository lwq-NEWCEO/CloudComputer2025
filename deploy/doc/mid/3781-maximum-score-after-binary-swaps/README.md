# [Maximum Score After Binary Swaps][title]
...
operation, you may choose an index `i` such that `0 <= i < n - 1`, where `s[i]
= '0'`, and `s[i + 1] = '1'`, and swap these two characters.
...
This is maximum score achievable.
...
There are no `'1'` characters in `s`, so no swaps can be performed. The score
remains 0.
...
[title]: https://leetcode.com/problems/maximum-score-after-binary-swaps
