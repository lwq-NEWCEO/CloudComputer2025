# [Minimum Cost to Acquire Required Items][title]

## Description

You are given five integers `cost1`, `cost2`, `costBoth`, `need1`, and
`need2`.
...
You must collect enough items so that the total contribution toward type 1 is
**at least** `need1` and the total contribution toward type 2 is **at least**
`need2`.

Return an integer representing the **minimum** possible total cost to achieve
these requirements.
...
We buy `need1 = 2` items of type 1 and `need2 = 3` items of type 2: `2 * 5 + 3
* 4 = 10 + 12 = 22`.  
...
[title]: https://leetcode.com/problems/minimum-cost-to-acquire-required-items
