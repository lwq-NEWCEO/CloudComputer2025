# [Maximum Product of Three Elements After One Replacement][title]

## Description

You are given an integer array `nums`.

You **must** replace **exactly one** element in the array with **any** integer
value in the range `[-105, 105]` (inclusive).
...
There is no way to replace an element with another integer and not have a 0 in
the array. Hence, the product of all three elements will always be 0, and the
...
[title]: https://leetcode.com/problems/maximum-product-of-three-elements-after-one-replacement
