# [Maximum K to Sort a Permutation][title]
...
== k`, where `AND` denotes the bitwise AND operation and `k` is a **non-
negative** integer.
...
[title]: https://leetcode.com/problems/maximum-k-to-sort-a-permutation
