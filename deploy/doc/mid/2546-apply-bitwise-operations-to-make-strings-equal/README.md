# [Apply Bitwise Operations to Make Strings Equal][title]
...
**Example 1:**
            Input: s = "1010", target = "0110"    Output: true    Explanation: We can do the following operations:    - Choose i = 2 and j = 0. We have now s = "**_0_** 0** _1_** 0".    - Choose i = 2 and j = 1. We have now s = "0** _11_** 0".    Since we can make s equal to target, we return true.    
...
[title]: https://leetcode.com/problems/apply-bitwise-operations-to-make-strings-equal
