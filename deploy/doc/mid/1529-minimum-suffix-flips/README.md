...
**Example 1:**
            Input: target = "10111"    Output: 3    Explanation: Initially, s = "00000".    Choose index i = 2: "00 _000_ " -> "00 _111_ "    Choose index i = 0: "_00111_ " -> "_11000_ "    Choose index i = 1: "1 _1000_ " -> "1 _0111_ "    We need at least 3 flip operations to form target.    

**Example 2:**
            Input: target = "101"    Output: 3    Explanation: Initially, s = "000".    Choose index i = 0: "_000_ " -> "_111_ "    Choose index i = 1: "1 _11_ " -> "1 _00_ "    Choose index i = 2: "10 _0_ " -> "10 _1_ "    We need at least 3 flip operations to form target.    
