# [Partition Array into Two Equal Product Subsets][title]
...
Determine if you can partition `nums` into two **non-empty** **disjoint**
**subsets** , with each element belonging to **exactly one** subset, such that
the product of the elements in each subset is equal to `target`.
...
Explanation: The subsets `[3, 8]` and `[1, 6, 4]` each have a product of
24. Hence, the output is true.
