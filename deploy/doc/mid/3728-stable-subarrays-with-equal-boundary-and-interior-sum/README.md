# [Stable Subarrays With Equal Boundary and Interior Sum][title]
...
No subarray of length at least 3 has equal first and last elements, so the
answer is 0.
...
`[-4,4,0,0,-8,-4]` is stable because the first and last elements are both -4,
and the sum of the elements strictly between them is `4 + 0 + 0 + (-8) = -4`
...
[title]: https://leetcode.com/problems/stable-subarrays-with-equal-boundary-and-interior-sum
