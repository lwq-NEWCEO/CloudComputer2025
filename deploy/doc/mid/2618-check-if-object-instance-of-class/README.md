# [Check if Object Instance of Class][title]
...
**Example 2:**
            Input: func = () => { class Animal {}; class Dog extends Animal {}; return checkIfInstanceOf(new Dog(), Animal); }    Output: true    Explanation:    class Animal {};    class Dog extends Animal {};    checkIfInstanceOf(new Dog(), Animal); // true        Dog is a subclass of Animal. Therefore, a Dog object is an instance of both Dog and Animal.
...
[title]: https://leetcode.com/problems/check-if-object-instance-of-class
