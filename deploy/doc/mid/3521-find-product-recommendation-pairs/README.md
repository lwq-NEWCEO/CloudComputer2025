# [Find Product Recommendation Pairs][title]
...
Return _the_ _result table ordered by**customer_count** in **descending**
order, and in case of a tie, by _`product1_id` _in**ascending** order, and
then by _`product2_id` _in**ascending** order_.
...
[title]: https://leetcode.com/problems/find-product-recommendation-pairs
