...
**Example 1:**
            Input: word = "aeiaaio _aaaaeiiiiouuu_ ooaauuaeiu"    Output: 13    Explanation: The longest beautiful substring in word is "aaaaeiiiiouuu" of length 13.

**Example 2:**
            Input: word = "aeeeiiiioooauuu _aeiou_ "    Output: 5    Explanation: The longest beautiful substring in word is "aeiou" of length 5.    
