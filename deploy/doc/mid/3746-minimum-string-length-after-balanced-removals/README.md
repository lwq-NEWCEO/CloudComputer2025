# [Minimum String Length After Balanced Removals][title]
...
removal, the remaining parts of the string are concatenated together without
gaps.
...
are equal, we can remove the entire string directly. The minimum length is 0.
...
[title]: https://leetcode.com/problems/minimum-string-length-after-balanced-removals
