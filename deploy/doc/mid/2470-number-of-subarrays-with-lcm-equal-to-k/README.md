# [Number of Subarrays With LCM Equal to K][title]
...
**Example 1:**
            Input: nums = [3,6,2,7,1], k = 6    Output: 4    Explanation: The subarrays of nums where 6 is the least common multiple of all the subarray's elements are:    - [_**3**_ ,_**6**_ ,2,7,1]    - [_**3**_ ,_**6**_ ,_**2**_ ,7,1]    - [3,_**6**_ ,2,7,1]    - [3,_**6**_ ,_**2**_ ,7,1]    
...
[title]: https://leetcode.com/problems/number-of-subarrays-with-lcm-equal-to-k
