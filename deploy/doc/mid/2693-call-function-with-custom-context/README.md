# [Call Function with Custom Context][title]
...
**Example 2:**
            Input:     fn = function tax(price, taxRate) {      return `The cost of the ${this.item} is ${price * taxRate}`;     }    args = [{"item": "burger"}, 10, 1.1]    Output: "The cost of the burger is 11"    Explanation: callPolyfill sets the "this" context to {"item": "burger"}. 10 and 1.1 are passed as additional arguments.    
...
[title]: https://leetcode.com/problems/call-function-with-custom-context
