# [Partition Array to Minimize XOR][title]

## Description

You are given an integer array `nums` and an integer `k`.

Your task is to partition `nums` into `k`**** non-empty **subarrays**. For
each subarray, compute the bitwise **XOR** of all its elements.
