# [Find COVID Recovery Patients][title]
...
Return _the result table ordered by_`recovery_time` _in**ascending** order,
then by _`patient_name` _in**ascending** order_.
...
[title]: https://leetcode.com/problems/find-covid-recovery-patients
