# [Find Emotionally Consistent Users][title]
...
Return _the result table ordered by_ `reaction_ratio` _in**descending** order
and then by_ `user_id` _in**ascending** order_.
...
Explanation:
  ...
  * **User 1** :     * Total reactions = 5    * like appears 4 times    * reaction_ratio = 4 / 5 = 0.80    * Meets the 60% consistency requirement
...
The Results table is ordered by reaction_ratio in descending order, then by
...
[title]: https://leetcode.com/problems/find-emotionally-consistent-users
