# [Twisted Mirror Path Count][title]
...
the bottom-right corner `(m - 1, n - 1)`. It can move only **right** or
**down**. If the robot attempts to move into a mirror cell, it is
...
entered while moving down, it will be turned right. This process will continue
until either the last cell is reached, the robot moves out of bounds or the
...
[title]: https://leetcode.com/problems/twisted-mirror-path-count
