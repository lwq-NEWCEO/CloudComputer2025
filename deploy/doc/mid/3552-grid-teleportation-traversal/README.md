# [Grid Teleportation Traversal][title]
...
right cell `(m - 1, n - 1)`. You can move from the current cell to any
...
![](https://assets.leetcode.com/uploads/2025/03/15/ezgifcom-animated-gif-
maker.gif)
