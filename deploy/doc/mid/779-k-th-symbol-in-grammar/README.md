...
**Example 1:**
            Input: n = 1, k = 1    Output: 0    Explanation: row 1: _0_    

**Example 2:**
            Input: n = 2, k = 1    Output: 0    Explanation:     row 1: 0    row 2: _0_ 1    

**Example 3:**
            Input: n = 2, k = 2    Output: 1    Explanation:     row 1: 0    row 2: 0 _1_    
