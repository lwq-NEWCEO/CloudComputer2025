# [Find Maximum Value in a Constrained Sequence][title]
...
of length `n`, denoted by `a[0], a[1], ..., a[n - 1]`, such that it satisfies
...
[title]: https://leetcode.com/problems/find-maximum-value-in-a-constrained-sequence
