...
**Example 1:**
            Input: arr = [3,2,4,1]    Output: [4,2,4,3]    Explanation:    We perform 4 pancake flips, with k values 4, 2, 4, and 3.    Starting state: arr = [3, 2, 4, 1]    After 1st flip (k = 4): arr = [_1_ , _4_ , _2_ , _3_]    After 2nd flip (k = 2): arr = [_4_ , _1_ , 2, 3]    After 3rd flip (k = 4): arr = [_3_ , _2_ , _1_ , _4_]    After 4th flip (k = 3): arr = [_1_ , _2_ , _3_ , 4], which is sorted.    
