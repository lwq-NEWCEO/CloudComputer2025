# [Maximal Score After Applying K Operations][title]
...
**Example 2:**
            Input: nums = [1,10,3,3,3], k = 3    Output: 17    Explanation: You can do the following operations:    Operation 1: Select i = 1, so nums becomes [1,**_4_** ,3,3,3]. Your score increases by 10.    Operation 2: Select i = 1, so nums becomes [1,**_2_** ,3,3,3]. Your score increases by 4.    Operation 3: Select i = 2, so nums becomes [1,2,_**1**_ ,3,3]. Your score increases by 3.    The final score is 10 + 4 + 3 = 17.    
