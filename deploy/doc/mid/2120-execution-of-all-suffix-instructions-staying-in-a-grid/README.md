...
![](https://assets.leetcode.com/uploads/2021/12/09/1.png)
            Input: n = 3, startPos = [0,1], s = "RRDDLU"    Output: [1,5,4,3,1,0]    Explanation: Starting from startPos and beginning execution from the ith instruction:    - 0th: "_**R**_ RDDLU". Only one instruction "R" can be executed before it moves off the grid.    - 1st:  "_**RDDLU**_ ". All five instructions can be executed while it stays in the grid and ends at (1, 1).    - 2nd:   "_**DDLU**_ ". All four instructions can be executed while it stays in the grid and ends at (1, 0).    - 3rd:    "_**DLU**_ ". All three instructions can be executed while it stays in the grid and ends at (0, 0).    - 4th:     "_**L**_ U". Only one instruction "L" can be executed before it moves off the grid.    - 5th:      "U". If moving up, it would move off the grid.    

**Example 2:**

![](https://assets.leetcode.com/uploads/2021/12/09/2.png)
            Input: n = 2, startPos = [1,1], s = "LURD"    Output: [4,1,0,0]    Explanation:    - 0th: "_**LURD**_ ".    - 1st:  "_**U**_ RD".    - 2nd:   "RD".    - 3rd:    "D".    
