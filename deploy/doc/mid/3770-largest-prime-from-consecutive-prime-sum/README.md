# [Largest Prime from Consecutive Prime Sum][title]
...
The prime numbers less than or equal to `n = 20` which are consecutive prime
sums are:
...
[title]: https://leetcode.com/problems/largest-prime-from-consecutive-prime-sum
