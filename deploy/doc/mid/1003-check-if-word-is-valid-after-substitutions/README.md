...
**Example 1:**
            Input: s = "aabcbc"    Output: true    Explanation:    "" -> "_abc_ " -> "a _abc_ bc"    Thus, "aabcbc" is valid.

**Example 2:**
            Input: s = "abcabcababcc"    Output: true    Explanation:    "" -> "_abc_ " -> "abc _abc_ " -> "abcabc _abc_ " -> "abcabcab _abc_ c"    Thus, "abcabcababcc" is valid.    
