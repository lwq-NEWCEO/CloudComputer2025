...
AuctionSystem auctionSystem = new AuctionSystem(); // Initialize the Auction
system  
...
auctionSystem.getHighestBidder(7); // return 1 as User 1 now has the highest
bid  
...
[title]: https://leetcode.com/problems/design-auction-system
