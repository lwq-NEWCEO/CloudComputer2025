# [Find Sum of Array Product of Magical Sequences][title]
...
Return the **sum** of the **array products** for all valid **magical**
sequences.
...
**Tags:** Array, Math, Dynamic Programming, Bit Manipulation, Combinatorics, Bitmask DP
