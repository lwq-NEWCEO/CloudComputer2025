...
1`, where `edges[i] = [ui, vi, lengthi]` indicates an edge between nodes `ui`
...
a descendant node in which all node values are **distinct** , except for **at
