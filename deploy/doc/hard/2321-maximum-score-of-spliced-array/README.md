# [Maximum Score Of Spliced Array][title]
...
**Example 1:**
            Input: nums1 = [60,60,60], nums2 = [10,90,10]    Output: 210    Explanation: Choosing left = 1 and right = 1, we have nums1 = [60,_**90**_ ,60] and nums2 = [10,_**60**_ ,10].    The score is max(sum(nums1), sum(nums2)) = max(210, 80) = 210.

**Example 2:**
            Input: nums1 = [20,40,20,70,30], nums2 = [50,20,50,40,20]    Output: 220    Explanation: Choosing left = 3, right = 4, we have nums1 = [20,40,20,_**40,20**_] and nums2 = [50,20,50,_**70,30**_].    The score is max(sum(nums1), sum(nums2)) = max(140, 220) = 220.    
