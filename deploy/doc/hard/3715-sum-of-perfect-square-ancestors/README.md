# [Sum of Perfect Square Ancestors][title]
...
Thus, the total number of valid ancestor pairs across all non-root nodes is `0
+ 1 + 1 = 2`.
...
[title]: https://leetcode.com/problems/sum-of-perfect-square-ancestors
