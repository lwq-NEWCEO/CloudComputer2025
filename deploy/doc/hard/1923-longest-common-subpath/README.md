...
**Example 1:**
            Input: n = 5, paths = [[0,1,_2,3_ ,4],                           [_2,3_ ,4],                           [4,0,1,_2,3_]]    Output: 2    Explanation: The longest common subpath is [2,3].    

**Example 2:**
            Input: n = 3, paths = [[0],[1],[2]]    Output: 0    Explanation: There is no common subpath shared by the three paths.    

**Example 3:**
            Input: n = 5, paths = [[_0_ ,1,2,3,4],                           [4,3,2,1,_0_]]    Output: 1    Explanation: The possible longest common subpaths are [0], [1], [2], [3], and [4]. All have a length of 1.
