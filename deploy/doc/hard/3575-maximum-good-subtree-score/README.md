# [Maximum Good Subtree Score][title]
...
A **subset** of nodes within the **subtree** of a node is called **good** if
every digit from 0 to 9 appears **at most** once in the decimal representation
...
the subtree rooted at node `u`, including `u` itself and all its descendants.
...
**Tags:** Array, Dynamic Programming, Bit Manipulation, Tree, Depth-First Search, Bitmask DP
