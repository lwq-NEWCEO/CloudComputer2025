...
**Example 2:**
            Input: expression = "(0&0)&(0&0&0)"    Output: 3    Explanation: We can turn "(0 _**& 0**_)**_&_**(0&0&0)" into "(0 _**|1**_)_**|**_(0&0&0)" using 3 operations.    The new expression evaluates to 1.    
