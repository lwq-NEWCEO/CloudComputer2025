# [Minimum Operations to Equalize Subarrays][title]
...
**all** elements in the **subarray** `nums[li..ri]` **equal**. If it is
impossible, the answer for that query is `-1`.
...
[title]: https://leetcode.com/problems/minimum-operations-to-equalize-subarrays
