# [Count Binary Palindromic Numbers][title]
...
All other values in `[0, 9]` have non-palindromic binary forms. Therefore, the
count is 6.
...
[title]: https://leetcode.com/problems/count-binary-palindromic-numbers
