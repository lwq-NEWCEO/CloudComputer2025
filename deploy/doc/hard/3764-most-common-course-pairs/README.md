# [Most Common Course Pairs][title]
...
Return _the result table ordered by_ _pair frequency in**descending** order_
_and then by first course name and second course name in**ascending** order_.
...
Explanation:
  ...
  * **Course Pairs Among Top Performers** :     * User 1: Python Basics -> SQL Fundamentals -> JavaScript -> React Basics -> Node.js -> Docker    * User 2: Python Basics -> React Basics -> Node.js -> Docker -> AWS Fundamentals    * Most common transitions: Node.js -> Docker (2 times), React Basics -> Node.js (2 times)

Results are ordered by transition_count in descending order, then by
first_course in ascending order, and then by second_course in ascending order.
...
[title]: https://leetcode.com/problems/most-common-course-pairs
