# [Count Routes to Climb a Rectangular Grid][title]
...
must start from _any cell_ in the bottom row (row `n - 1`) and end in the top
row (row 0).
...
[title]: https://leetcode.com/problems/count-routes-to-climb-a-rectangular-grid
