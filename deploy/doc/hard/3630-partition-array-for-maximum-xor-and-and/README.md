# [Partition Array for Maximum XOR and AND][title]

## Description

You are given an integer array `nums`.

Partition the array into **three** (possibly empty) subsequences `A`, `B`, and
`C` such that every element of `nums` belongs to **exactly** one subsequence.
...
[title]: https://leetcode.com/problems/partition-array-for-maximum-xor-and-and
