# [Minimum Operations to Make Elements Within K Subarrays Equal][title]
...
_non-overlapping subarrays_ of size **exactly** `x` in `nums`, where all
elements within each subarray are equal.
