...
**Example 1:**
            Input: s = "leet", k = 3, letter = "e", repetition = 1    Output: "eet"    Explanation: There are four subsequences of length 3 that have the letter 'e' appear at least 1 time:    - "lee" (from "**_lee_** t")    - "let" (from "**_le_** e _**t**_ ")    - "let" (from "_**l**_ e _**et**_ ")    - "eet" (from "l _**eet**_ ")    The lexicographically smallest subsequence among them is "eet".    
