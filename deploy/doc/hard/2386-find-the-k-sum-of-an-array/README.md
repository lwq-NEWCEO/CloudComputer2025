# [Find the K-Sum of an Array][title]
...
**Example 1:**
            Input: nums = [2,4,-2], k = 5    Output: 2    Explanation: All the possible subsequence sums that we can obtain are the following sorted in decreasing order:    6, 4, 4, 2, _2_ , 0, 0, -2.    The 5-Sum of the array is 2.    
