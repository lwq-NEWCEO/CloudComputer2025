# [Maximum Walls Destroyed by Robots][title]
...
are fixed obstacles: if a bullet hits another robot before reaching a wall, it
**immediately stops** at that robot and cannot continue.
