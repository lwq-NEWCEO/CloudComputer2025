# [Maximum XOR of Subsequences][title]
...
Select **two** subsequences of `nums` (they may be empty and are **allowed**
to **overlap**), each preserving the original order of elements, and let:
...
[title]: https://leetcode.com/problems/maximum-xor-of-subsequences
