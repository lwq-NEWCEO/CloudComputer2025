# [Maximum Profit from Trading Stocks with Discounts][title]
...
is the CEO, is the direct or indirect boss of every employee. You are given
two **1-based** integer arrays, `present` and `future`, each of length `n`,
where:
...
Input: n = 2, present = [1,2], future = [4,3], hierarchy = [[1,2]], budget
= 3
...
Input: n = 2, present = [3,4], future = [5,8], hierarchy = [[1,2]], budget
= 4
