# [Merge Operations for Minimum Travel Time][title]
...
Return the **minimum** **total** **travel time** (in minutes) to travel from 0
to `l` after **exactly** `k` merges.
...
Explanation:
  ...
  * After the merge:     * `position` array: `[0, 8, 10]`    * `time` array: `[5, 11, 6]`    *   * Segment | Distance (km) | Time per km (min) | Segment Travel Time (min)  
---|---|---|---  
0 -> 8 | 8 | 5 | 8 × 5 = 40  
8 -> 10 | 2 | 11 | 2 × 11 = 22  
...
Explanation:
  ...
  * After the merge:     * `position` array: `[0, 2, 3, 5]`    * `time` array: `[8, 12, 3, 3]`    *   * Segment | Distance (km) | Time per km (min) | Segment Travel Time (min)  
---|---|---|---  
0 -> 2 | 2 | 8 | 2 × 8 = 16  
2 -> 3 | 1 | 12 | 1 × 12 = 12  
3 -> 5 | 2 | 3 | 2 × 3 = 6  
