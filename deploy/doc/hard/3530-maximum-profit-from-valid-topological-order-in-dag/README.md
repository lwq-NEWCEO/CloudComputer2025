# [Maximum Profit from Valid Topological Order in DAG][title]
...
**score** given in an array `score`, where `score[i]` represents the score of
node `i`.
...
**Tags:** Array, Dynamic Programming, Bit Manipulation, Graph Theory, Topological Sort, Bitmask DP
