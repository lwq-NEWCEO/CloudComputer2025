# [Threshold Majority Queries][title]
...
selecting the element with the **highest** frequency (choosing the
**smallest** in case of a tie), or -1 if no such element _exists_.
...
[title]: https://leetcode.com/problems/threshold-majority-queries
