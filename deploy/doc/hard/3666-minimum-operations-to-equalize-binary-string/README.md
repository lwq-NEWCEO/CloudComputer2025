# [Minimum Operations to Equalize Binary String][title]

## Description

You are given a binary string `s`, and an integer `k`.

In one operation, you must choose **exactly** `k` **different** indices and
**flip** each `'0'` to `'1'` and each `'1'` to `'0'`.
...
[title]: https://leetcode.com/problems/minimum-operations-to-equalize-binary-string
